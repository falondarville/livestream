function onSignIn(googleUser) {
	...
	$.ajax({
		...
		$('#data').empty();
		var videoID =  data.items[4].id.videoId;
		...
		$('#data').append('<iframe height="315" src="https://www.youtube.com/live_chat?v=' + videoID + '&embed_domain=' + window.location.hostname + '"></iframe>');
